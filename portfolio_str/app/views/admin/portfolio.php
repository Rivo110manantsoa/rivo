                            ...
                            <?php if(isset($rows) && is_array($rows)):?>
                                    <?php $i=0; foreach($rows as $row):$i++;?>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><?=$row->date?></p></td>
                                            <td class="flex-btn">
                                                <button onclick="edit_portfolioo(<?=$row->id?>,event)" info_portfolio = <?= $info ?> class="btn"><i class="fa-solid fa-pen-to-square"></i></button>
                                                <button onclick="delete_portfolioo(<?=$row->id?>)" class="btn"><i class="fa-solid fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
                            <?php else:?>
        ...
        <div class="modal-body">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="date" id="edit-date" class="form-control">
                </div>
                <div class="form-group">
                    <label>Choose many images to your portfolio</label>
                    <div class="flex-btn">
...
function collect_data(e){
    ...
    if (link.value.trim() == "" || !isNaN(link.value.trim())) {
        alert("Please inter a valid link");
        return;
    }
    if (date.value.trim() == "" || !isNaN(date.value.trim())) {
    ...
    data.append('date',date.value.trim());
...
if (edit_date.value.trim() == "" || !isNaN(edit_date.value.trim())) {
    alert("Please enter a valid title!");
    return;
}
...
data.append('date',edit_date.value.trim());
...
function handle_result(result){
    ...
    if (result != "") {
        ...
        if (typeof obj.message != "undefined" ) {
            ...
            if( obj.data_type == "edit_portfolio"){
               alert(obj.message);
               window.location.reload();            
            } else
            if( obj.data_type == "delete_portfolio"){
               alert(obj.message);
               window.location.reload();
